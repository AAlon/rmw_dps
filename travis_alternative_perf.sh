...
docker exec osrf_ros2_nightly /bin/bash -c "source /opt/ros/dashing/setup.bash && cd /shared && colcon build"
docker exec osrf_ros2_nightly /bin/bash -c "source /shared/install/local_setup.bash && ./shared/install/benchmark/lib/benchmark/benchmark /shared/install/benchmark/lib/benchmark/topology/sierra_nevada.json -t 60 --ipc on"
